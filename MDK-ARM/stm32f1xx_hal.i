...
#line 55 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal.c"
...
#line 85 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal.c"
...
HAL_StatusTypeDef HAL_Init(void)
{
  ...
  (((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->ACR |= (0x1U << (4U)));
...
HAL_StatusTypeDef HAL_DeInit(void)
{
  ...
  (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2RSTR = 0xFFFFFFFFU);
  (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB1RSTR = 0x00);

  (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2RSTR = 0xFFFFFFFFU);
  (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2RSTR = 0x00);
...
uint32_t HAL_GetHalVersion(void)
{
 return (((0x01) << 24) |((0x00) << 16) |((0x04) << 8 ) |((0x00)));
}
...
uint32_t HAL_GetREVID(void)
{
  return((((DBGMCU_TypeDef *) ((uint32_t)0xE0042000))->IDCODE) >> (__clz(__rbit((0xFFFFU << (16U))))));
}
...
void HAL_DBGMCU_EnableDBGSleepMode(void)
{
  ((((DBGMCU_TypeDef *) ((uint32_t)0xE0042000))->CR) |= ((0x1U << (0U))));
}
...
void HAL_DBGMCU_EnableDBGStopMode(void)
{
  ((((DBGMCU_TypeDef *) ((uint32_t)0xE0042000))->CR) |= ((0x1U << (1U))));
}
...
void HAL_DBGMCU_EnableDBGStandbyMode(void)
{
  ((((DBGMCU_TypeDef *) ((uint32_t)0xE0042000))->CR) |= ((0x1U << (2U))));
}
