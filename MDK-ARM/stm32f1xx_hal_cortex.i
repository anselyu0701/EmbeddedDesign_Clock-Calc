...
#line 124 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_cortex.c"
...
#line 340 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_cortex.c"
...
void HAL_SYSTICK_CLKSourceConfig(uint32_t CLKSource)
{
  ...
  ((void)0);
  if (CLKSource == ((uint32_t)0x00000004))
  {
