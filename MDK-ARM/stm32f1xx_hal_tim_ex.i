...
#line 101 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_tim_ex.c"
...
HAL_StatusTypeDef HAL_TIMEx_HallSensor_Init(TIM_HandleTypeDef *htim, TIM_HallSensor_InitTypeDef* sConfig)
{
  ...
  htim->Instance->SMCR |= ((uint32_t)0x0040);

   
  htim->Instance->SMCR &= ~(0x7U << (0U));
  htim->Instance->SMCR |= ((uint32_t)0x0004);

   
  OC_Config.OCFastMode = ((uint32_t)0x0000);
  OC_Config.OCIdleState = ((uint32_t)0x0000);
  OC_Config.OCMode = ((0x7U << (4U)));
  OC_Config.OCNIdleState = ((uint32_t)0x0000);
  OC_Config.OCNPolarity = ((uint32_t)0x0000);
  OC_Config.OCPolarity = ((uint32_t)0x0000);
...
HAL_StatusTypeDef HAL_TIMEx_OCN_Start(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  ...
  TIM_CCxNChannelCmd(htim->Instance, Channel, ((uint32_t)0x0004));
...
HAL_StatusTypeDef HAL_TIMEx_OCN_Stop(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  ...
  TIM_CCxNChannelCmd(htim->Instance, Channel, ((uint32_t)0x0000));
...
HAL_StatusTypeDef HAL_TIMEx_OnePulseN_Start(TIM_HandleTypeDef *htim, uint32_t OutputChannel)
  ...
  TIM_CCxNChannelCmd(htim->Instance, OutputChannel, ((uint32_t)0x0004));
...
HAL_StatusTypeDef HAL_TIMEx_OnePulseN_Stop(TIM_HandleTypeDef *htim, uint32_t OutputChannel)
{
  ...
  TIM_CCxNChannelCmd(htim->Instance, OutputChannel, ((uint32_t)0x0000));
...
HAL_StatusTypeDef HAL_TIMEx_ConfigCommutationEvent(TIM_HandleTypeDef *htim, uint32_t  InputTrigger, uint32_t  CommutationSource)
{
  ...
  if ((InputTrigger == ((uint32_t)0x0000)) || (InputTrigger == ((uint32_t)0x0010)) ||
      (InputTrigger == ((uint32_t)0x0020)) || (InputTrigger == ((uint32_t)0x0030)))
  {
