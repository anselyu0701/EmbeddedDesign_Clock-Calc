...
#line 155 "..\\Drivers\\STM32F1xx_HAL_Driver\\Src\\stm32f1xx_hal_spi.c"
...
__weak HAL_StatusTypeDef HAL_SPI_Init(SPI_HandleTypeDef *hspi)
{
  ...
  ((hspi->Instance ->CR2) = ((((hspi->Init . NSS >> 16) & (0x1U << (2U))) | hspi->Init . TIMode)));

   
   
  ((hspi->Instance ->CRCPR) = (hspi->Init . CRCPolynomial));

  hspi->ErrorCode = ((uint32_t)0x00);
...
HAL_StatusTypeDef HAL_SPI_Transmit(SPI_HandleTypeDef *hspi, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if(hspi->State == HAL_SPI_STATE_READY)
  {
    ...
    {
      do{(((hspi)->Instance ->CR1) &= ~((0x1U << (13U)))); (((hspi)->Instance ->CR1) |= ((0x1U << (13U))));}while(0);
    }
    ...
    if(hspi->Init.DataSize == ((uint32_t)0x00000000))
    {
      if((hspi->Init.Mode == ((uint32_t)0x00000000))|| (hspi->TxXferCount == 0x01))
      {
      ...
      while(hspi->TxXferCount > 0)
      {
        ...
        if(SPI_WaitOnFlagUntilTimeout(hspi, (0x1U << (1U)), RESET, Timeout) != HAL_OK)
        { 
          return HAL_TIMEOUT;
        }
        hspi->Instance->DR = (*hspi->pTxBuffPtr++);
    ...
    if(SPI_WaitOnFlagUntilTimeout(hspi, (0x1U << (1U)), RESET, Timeout) != HAL_OK)
    {
      ((hspi->ErrorCode) |= (((uint32_t)0x10)));
      return HAL_TIMEOUT;
    }

     
    if(SPI_WaitOnFlagUntilTimeout(hspi, (0x1U << (7U)), SET, Timeout) != HAL_OK)
    { 
      ((hspi->ErrorCode) |= (((uint32_t)0x10)));
      return HAL_TIMEOUT;
    }
    ...
    if(hspi->Init.Direction == ((uint32_t)0x00000000))
    {
      do{ volatile uint32_t tmpreg; tmpreg = (hspi)->Instance ->DR; tmpreg = (hspi)->Instance ->SR; ((void)(tmpreg)); }while(0);
    }
...
HAL_StatusTypeDef HAL_SPI_Receive(SPI_HandleTypeDef *hspi, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if(hspi->State == HAL_SPI_STATE_READY)
  {
    ...
    if((hspi->Init.Mode == ((0x1U << (2U)) | (0x1U << (8U)))) && (hspi->Init.Direction == ((uint32_t)0x00000000)))
    {
    ...
    if(hspi->Init.DataSize == ((uint32_t)0x00000000))
    {
      while(hspi->RxXferCount > 1)
      {
        ...
        if(SPI_WaitOnFlagUntilTimeout(hspi, (0x1U << (0U)), RESET, Timeout) != HAL_OK)
        { 
          return HAL_TIMEOUT;
        }
    ...
    if((hspi->Init.CRCCalculation == (0x1U << (13U))) && (((((hspi)->Instance ->SR) & ((0x1U << (4U)))) == ((0x1U << (4U)))) != RESET))
    {  
       
      if (SPI_ISCRCErrorValid(hspi) == 1)
      {
        ((hspi->ErrorCode) |= (((uint32_t)0x02)));
...
HAL_StatusTypeDef HAL_SPI_TransmitReceive(SPI_HandleTypeDef *hspi, uint8_t *pTxData, uint8_t *pRxData, uint16_t Size, uint32_t Timeout)
{
  ...
  if((hspi->State == HAL_SPI_STATE_READY) || (hspi->State == HAL_SPI_STATE_BUSY_RX))
  {
    ...
    {
      if((hspi->Init.Mode == ((uint32_t)0x00000000)) || ((hspi->Init.Mode == ((0x1U << (2U)) | (0x1U << (8U)))) && (hspi->TxXferCount == 0x01)))
      {
        hspi->Instance->DR = *((uint16_t*)hspi->pTxBuffPtr);
        hspi->pTxBuffPtr+=2;
        hspi->TxXferCount--;
      ...
      else
      {
        while(hspi->TxXferCount > 0)
        {
          ...
          if((hspi->TxXferCount == 0) && (hspi->Init.CRCCalculation == (0x1U << (13U))))
          {
            ((hspi->Instance ->CR1) |= ((0x1U << (12U))));
          }
        ...
        if(hspi->Init.Mode == ((uint32_t)0x00000000))
        {
...
HAL_StatusTypeDef HAL_SPI_Receive_IT(SPI_HandleTypeDef *hspi, uint8_t *pData, uint16_t Size)
{
  if(hspi->State == HAL_SPI_STATE_READY)
  {
    ...
    else if((hspi->Init.Direction == ((uint32_t)0x00000000)) && (hspi->Init.Mode == ((0x1U << (2U)) | (0x1U << (8U)))))
    {
...
HAL_StatusTypeDef HAL_SPI_TransmitReceive_IT(SPI_HandleTypeDef *hspi, uint8_t *pTxData, uint8_t *pRxData, uint16_t Size)
{
  ...
  if((hspi->State == HAL_SPI_STATE_READY) ||      ((hspi->Init.Mode == ((0x1U << (2U)) | (0x1U << (8U)))) && (hspi->Init.Direction == ((uint32_t)0x00000000)) && (hspi->State == HAL_SPI_STATE_BUSY_RX)))
...
void HAL_SPI_IRQHandler(SPI_HandleTypeDef *hspi)
{
  ...
  if((((((hspi)->Instance ->CR2 & ((0x1U << (6U)))) == ((0x1U << (6U)))) ? SET : RESET) != RESET) && (((((hspi)->Instance ->SR) & ((0x1U << (0U)))) == ((0x1U << (0U)))) != RESET) && (((((hspi)->Instance ->SR) & ((0x1U << (6U)))) == ((0x1U << (6U)))) == RESET))
  {
    hspi->RxISR(hspi);
    return;
  }
  ...
  if((((((hspi)->Instance ->CR2 & ((0x1U << (7U)))) == ((0x1U << (7U)))) ? SET : RESET) != RESET) && (((((hspi)->Instance ->SR) & ((0x1U << (1U)))) == ((0x1U << (1U)))) != RESET))
  {
    hspi->TxISR(hspi);
    return;
  }

  if(((((hspi)->Instance ->CR2 & ((0x1U << (5U)))) == ((0x1U << (5U)))) ? SET : RESET) != RESET)
  {
    ...
    if(((((hspi)->Instance ->SR) & ((0x1U << (5U)))) == ((0x1U << (5U)))) != RESET)
    {
      ((hspi->ErrorCode) |= (((uint32_t)0x01)));
      do{ volatile uint32_t tmpreg; tmpreg = (hspi)->Instance ->SR; tmpreg = (((hspi)->Instance ->CR1) &= ~((0x1U << (6U)))); ((void)(tmpreg)); }while(0);
    }
    
     
    if(((((hspi)->Instance ->SR) & ((0x1U << (6U)))) == ((0x1U << (6U)))) != RESET)
    {
      if(hspi->State != HAL_SPI_STATE_BUSY_TX)
      {
        ((hspi->ErrorCode) |= (((uint32_t)0x04)));
        do{ volatile uint32_t tmpreg; tmpreg = (hspi)->Instance ->DR; tmpreg = (hspi)->Instance ->SR; ((void)(tmpreg)); }while(0);      
      }
    }

     
    if(hspi->ErrorCode!=((uint32_t)0x00))
    {
...
static void SPI_TxCloseIRQHandler(SPI_HandleTypeDef *hspi)
{
  ...
  if(SPI_WaitOnFlagUntilTimeout(hspi, (0x1U << (1U)), RESET, 10) != HAL_OK)
  {
    ((hspi->ErrorCode) |= (((uint32_t)0x10)));
  }
  ...
  if(((((hspi)->Instance ->CR2 & ((0x1U << (6U)))) == ((0x1U << (6U)))) ? SET : RESET) == RESET)
  {
    (((hspi)->Instance ->CR2) &= ~((((0x1U << (5U))))));

     
    if(SPI_WaitOnFlagUntilTimeout(hspi, (0x1U << (7U)), SET, 10) != HAL_OK)
    {
      ((hspi->ErrorCode) |= (((uint32_t)0x10)));
    }
...
static void SPI_RxCloseIRQHandler(SPI_HandleTypeDef *hspi)
{
  ...
  if(hspi->Init.CRCCalculation == (0x1U << (13U)))
  {
    ...
    if(SPI_WaitOnFlagUntilTimeout(hspi, (0x1U << (0U)), RESET, 10) != HAL_OK)
    {
      ((hspi->ErrorCode) |= (((uint32_t)0x10)));
    }
    ...
    if(SPI_WaitOnFlagUntilTimeout(hspi, (0x1U << (0U)), SET, 10) != HAL_OK)
    {
      ((hspi->ErrorCode) |= (((uint32_t)0x10)));
    }
  ...
  if(((((hspi)->Instance ->CR2 & ((0x1U << (7U)))) == ((0x1U << (7U)))) ? SET : RESET) == RESET)
  {
...
static void SPI_RxISR(SPI_HandleTypeDef *hspi)
{
  ...
  if((hspi->RxXferCount == 1) && (hspi->Init.CRCCalculation == (0x1U << (13U))))
  {
...
static void SPI_DMATransmitCplt(DMA_HandleTypeDef *hdma)
{
  ...
  if((hdma->Instance->CCR & ((uint32_t)(0x1U << (5U)))) == 0)
  {
...
static HAL_StatusTypeDef SPI_WaitOnFlagUntilTimeout(SPI_HandleTypeDef *hspi, uint32_t Flag, FlagStatus Status, uint32_t Timeout)  
{
  ...
  if(Status == RESET)
  {
    while(((((hspi)->Instance ->SR) & (Flag)) == (Flag)) == RESET)
    {
