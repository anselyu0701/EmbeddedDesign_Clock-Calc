...
#line 36 "..\\Src\\stm32f1xx_hal_timebase_TIM.c"
#line 37 "..\\Src\\stm32f1xx_hal_timebase_TIM.c"
...
HAL_StatusTypeDef HAL_InitTick(uint32_t TickPriority)
{
  ...
  do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR) |= ((0x1U << (11U)))); tmpreg = ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR) & ((0x1U << (11U)))); ((void)(tmpreg)); } while(0);
  ...
  htim1.Instance = ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2C00));
  ...
  htim1.Init.CounterMode = ((uint32_t)0x0000);
