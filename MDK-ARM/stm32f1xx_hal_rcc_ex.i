...
#line 44 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_rcc_ex.c"
...
HAL_StatusTypeDef HAL_RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef  *PeriphClkInit)
{
  ...
  if ((((PeriphClkInit->PeriphClockSelection) & ((uint32_t)0x00000001)) == ((uint32_t)0x00000001)))
  {
    ...
    temp_reg = (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->BDCR & (0x3U << (8U)));
    if((temp_reg != 0x00000000U) && (temp_reg != (PeriphClkInit->RTCClockSelection & (0x3U << (8U)))))
    {
       
      temp_reg = (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->BDCR & ~((0x3U << (8U))));
       
      (*(volatile uint32_t *) ((uint32_t)(((uint32_t)0x42000000) + (((((((uint32_t)0x40000000) + 0x20000) + 0x1000) - ((uint32_t)0x40000000)) + 0x20) * 32) + ((__clz(__rbit((0x1U << (16U))))) * 4))) = ENABLE);
      (*(volatile uint32_t *) ((uint32_t)(((uint32_t)0x42000000) + (((((((uint32_t)0x40000000) + 0x20000) + 0x1000) - ((uint32_t)0x40000000)) + 0x20) * 32) + ((__clz(__rbit((0x1U << (16U))))) * 4))) = DISABLE);
       
      ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->BDCR = temp_reg;

       
      if ((((temp_reg) & ((0x1U << (0U)))) != RESET))
      {
    ...
    (((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->BDCR)) = ((((((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->BDCR))) & (~((0x3U << (8U))))) | ((PeriphClkInit->RTCClockSelection))))); 
  }

    
  if(((PeriphClkInit->PeriphClockSelection) & ((uint32_t)0x00000002)) == ((uint32_t)0x00000002))
  {
     
    ((void)0);
    
     
    (((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR)) = ((((((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR))) & (~((0x3U << (14U))))) | ((uint32_t)(PeriphClkInit->AdcClockSelection)))));
  }

#line 270 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_rcc_ex.c"




    
  if(((PeriphClkInit->PeriphClockSelection) & ((uint32_t)0x00000010)) == ((uint32_t)0x00000010))
  {
     
    ((void)0);
    
     
    (((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR)) = ((((((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR))) & (~((0x1U << (22U))))) | ((uint32_t)(PeriphClkInit->UsbClockSelection)))));
  }
...
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef  *PeriphClkInit)
{
  ...
  PeriphClkInit->PeriphClockSelection = ((uint32_t)0x00000001);

   
  srcclk = (((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->BDCR) & ((0x3U << (8U)))));
   
  PeriphClkInit->RTCClockSelection = srcclk;

   
  PeriphClkInit->PeriphClockSelection |= ((uint32_t)0x00000002);
  PeriphClkInit->AdcClockSelection = ((uint32_t)(((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR) & ((0x3U << (14U))))));

#line 321 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_rcc_ex.c"

#line 332 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_rcc_ex.c"




   
  PeriphClkInit->PeriphClockSelection |= ((uint32_t)0x00000010);
  PeriphClkInit->UsbClockSelection = ((uint32_t)(((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR) & ((0x1U << (22U))))));
...
uint32_t HAL_RCCEx_GetPeriphCLKFreq(uint32_t PeriphClk)
{
#line 397 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_rcc_ex.c"
  ...
  case ((uint32_t)0x00000010):  
    {
      ...
      temp_reg = ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR;
  
       
      if ((((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CR) & ((0x1U << (24U)))) != RESET))
      {
        pllmul = aPLLMULFactorTable[(uint32_t)(temp_reg & (0xFU << (18U))) >> (__clz(__rbit((0xFU << (18U)))))];
        if ((temp_reg & (0x1U << (16U))) != ((uint32_t)0x00000000))
        {




          prediv1 = aPredivFactorTable[(uint32_t)(((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR & (0x1U << (17U))) >> (__clz(__rbit((0x1U << (17U)))))];


#line 459 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_rcc_ex.c"
          if ((temp_reg & (0x1U << (16U))) != ((uint32_t)0x00000000))
          {
             
            pllclk = (uint32_t)((((uint32_t)8000000) / prediv1) * pllmul);
          }
...
#line 486 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_rcc_ex.c"
         
        if (((uint32_t)(((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR) & ((0x1U << (22U)))))) == (0x1U << (22U)))
        {
...
#line 555 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_rcc_ex.c"
  case ((uint32_t)0x00000001):  
    {
       
      temp_reg = ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->BDCR;

       
      if (((temp_reg & (0x3U << (8U))) == ((uint32_t)0x00000100)) && ((((temp_reg) & ((0x1U << (1U)))) != RESET)))
      {
        frequency = ((uint32_t)32768);
      }
       
      else if (((temp_reg & (0x3U << (8U))) == ((uint32_t)0x00000200)) && ((((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CSR) & ((0x1U << (1U)))) != RESET)))
      {
        frequency = ((uint32_t)40000);
      }
      else if (((temp_reg & (0x3U << (8U))) == ((uint32_t)0x00000300)) && ((((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CR) & ((0x1U << (17U)))) != RESET)))
      {
        frequency = ((uint32_t)8000000) / 128;
      }
  ...
  case ((uint32_t)0x00000002):  
    {
      frequency = HAL_RCC_GetPCLK2Freq() / (((((uint32_t)(((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR) & ((0x3U << (14U)))))) >> (__clz(__rbit(((uint32_t)0x00004000))))) + 1) * 2);
      break;
    }
  default: 
    {
...
#line 854 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_rcc_ex.c"
