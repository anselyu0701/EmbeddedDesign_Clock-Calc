...
osThreadId osThreadCreate (const osThreadDef_t *thread_def, void *argument)
{
  ...
  if (xTaskGenericCreate( ( (TaskFunction_t)thread_def->pthread ), ( (const char *)thread_def->name ), ( thread_def->stacksize ), ( argument ), ( makeFreeRtosPriority(thread_def->tpriority) ), ( &handle ), ( 0 ), ( 0 ) ) != ( ( ( BaseType_t ) 1 ) ))  {
...
#line 330 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\CMSIS_RTOS\\cmsis_os.c"
...
osTimerId osTimerCreate (const osTimerDef_t *timer_def, os_timer_type type, void *argument)
{
#line 349 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\CMSIS_RTOS\\cmsis_os.c"
	return 0;
...
#line 388 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\CMSIS_RTOS\\cmsis_os.c"
  result = osErrorOS;
...
{
  osStatus result = osOK;
#line 417 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\CMSIS_RTOS\\cmsis_os.c"
  result = osErrorOS;
...
#line 444 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\CMSIS_RTOS\\cmsis_os.c"
  result = osErrorOS;
...
int32_t osSignalSet (osThreadId thread_id, int32_t signal)
{
  ...
  if (inHandlerMode())
  {
    if(xTaskGenericNotifyFromISR( ( thread_id ), ( (uint32_t)signal ), ( eSetBits ), 0, ( &xHigherPriorityTaskWoken ) ) != ( ( ( BaseType_t ) 1 ) ) )
      return osErrorOS;

    if( xHigherPriorityTaskWoken ) ( * ( ( volatile uint32_t * ) 0xe000ed04 ) ) = ( 1UL << 28UL );
  }  
  else if(xTaskGenericNotify( ( thread_id ), ( (uint32_t)signal ), ( eSetBits ), 0 ) != ( ( ( BaseType_t ) 1 ) ) )
  {
    return osErrorOS;
  }
  
  return osOK;
#line 482 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\CMSIS_RTOS\\cmsis_os.c"
}
...
#line 543 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\CMSIS_RTOS\\cmsis_os.c"
...
#line 1289 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\CMSIS_RTOS\\cmsis_os.c"

#line 1304 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\CMSIS_RTOS\\cmsis_os.c"
...
osStatus osThreadResume (osThreadId thread_id)
{
  ...
  if(inHandlerMode())
  {
    ...
    {
      if( ( ( BaseType_t ) 1 ) ) ( * ( ( volatile uint32_t * ) 0xe000ed04 ) ) = ( 1UL << 28UL );
    }
  }
  else
  {
...
osStatus osDelayUntil (uint32_t *PreviousWakeTime, uint32_t millisec)
{
#line 1385 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\CMSIS_RTOS\\cmsis_os.c"
  (void) millisec;
...
osStatus osRecursiveMutexRelease (osMutexId mutex_id)
{
#line 1480 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\CMSIS_RTOS\\cmsis_os.c"
	return osErrorResource;
...
osStatus osRecursiveMutexWait (osMutexId mutex_id, uint32_t millisec)
{
#line 1520 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\CMSIS_RTOS\\cmsis_os.c"
	return osErrorResource;
