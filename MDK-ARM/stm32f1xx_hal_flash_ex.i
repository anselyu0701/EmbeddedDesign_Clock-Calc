...
#line 62 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"
...
HAL_StatusTypeDef HAL_FLASHEx_Erase(FLASH_EraseInitTypeDef *pEraseInit, uint32_t *PageError)
{
  ...
  if (pEraseInit->TypeErase == ((uint32_t)0x02))
  {
#line 230 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"
    {
       
       
      if (FLASH_WaitForLastOperation((uint32_t)((uint32_t)50000)) == HAL_OK)
      {
         
        FLASH_MassErase(((uint32_t)1));
...
#line 287 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"
   {
      ...
      if (FLASH_WaitForLastOperation((uint32_t)((uint32_t)50000)) == HAL_OK)
      {
        ...
        *PageError = 0xFFFFFFFF;
        ...
        for(address = pEraseInit->PageAddress;
            address < ((pEraseInit->NbPages * ((uint32_t)0x400)) + pEraseInit->PageAddress);
            address += ((uint32_t)0x400))
        {
...
HAL_StatusTypeDef HAL_FLASHEx_OBErase(void)
{
  ...
  if(status == HAL_OK)
  {
    ...
    ((((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CR) |= ((0x1U << (5U))));
    ((((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CR) |= ((0x1U << (6U))));
...
HAL_StatusTypeDef HAL_FLASHEx_OBProgram(FLASH_OBProgramInitTypeDef *pOBInit)
{
  ...
  if((pOBInit->OptionType & ((uint32_t)0x01)) == ((uint32_t)0x01))
  {
    ((void)0);
    if (pOBInit->WRPState == ((uint32_t)0x01))
    {
  ...
  if((pOBInit->OptionType & ((uint32_t)0x02)) == ((uint32_t)0x02))
  {
  ...
  if((pOBInit->OptionType & ((uint32_t)0x04)) == ((uint32_t)0x04))
  {
  ...
  if((pOBInit->OptionType & ((uint32_t)0x08)) == ((uint32_t)0x08))
  {
...
void HAL_FLASHEx_OBGetConfig(FLASH_OBProgramInitTypeDef *pOBInit)
{
  pOBInit->OptionType = ((uint32_t)0x01) | ((uint32_t)0x02) | ((uint32_t)0x04);
...
uint32_t HAL_FLASHEx_OBGetUserData(uint32_t DATAAdress)
{
  ...
  if (DATAAdress == ((uint32_t)0x1FFFF804))
  {
     
    value = ((((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->OBR) & ((0xFFU << (10U)))) >> (uint32_t)(__clz(__rbit((0xFFU << (10U)))));
  }
  else
  {
     
    value = ((((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->OBR) & ((0xFFU << (18U)))) >> (uint32_t)(__clz(__rbit((0xFFU << (18U)))));
  }
...
#line 638 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"
...
#line 670 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"
  ...
  WRP0_Data = (uint16_t)(WriteProtectPage & ((uint32_t)0x000000FF));
...
#line 695 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"

#line 705 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"
  ...
  { 
    ...
    if (status == HAL_OK)  
    {
      ...
      ((((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CR) |= ((0x1U << (4U))));
...
#line 740 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"

#line 750 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"

#line 760 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"
...
static HAL_StatusTypeDef FLASH_OB_DisableWRP(uint32_t WriteProtectPage)
{
  HAL_StatusTypeDef status = HAL_OK;
  uint16_t WRP0_Data = 0xFFFF;
#line 793 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"
...
#line 818 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"

#line 828 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"
...
#line 863 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"

#line 873 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"

#line 883 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"
...
static HAL_StatusTypeDef FLASH_OB_RDP_LevelConfig(uint8_t ReadProtectLevel)
{
  ...
  { 
    ...
    if(status == HAL_OK)
    {
      ...
      ((((OB_TypeDef *) ((uint32_t)0x1FFFF800))->RDP) = (ReadProtectLevel));
...
static HAL_StatusTypeDef FLASH_OB_UserConfig(uint8_t UserConfig)
{
  ...
  {     
    ...
    ((OB_TypeDef *) ((uint32_t)0x1FFFF800))->USER = (UserConfig | 0x88);
...
static uint32_t FLASH_OB_GetRDP(void)
{
  ...
  tmp_reg = ((((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->OBR) & ((0x1U << (1U))));
...
static uint8_t FLASH_OB_GetUser(void)
{
  ...
  return (uint8_t)((((((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->OBR)) & (0x7U << (2U))) >> (uint32_t)(__clz(__rbit((0x1U << (2U))))));
}
...
#line 1118 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"
     
    ((((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CR) |= ((0x1U << (1U))));
    ((((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->AR) = (PageAddress));
    ((((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CR) |= ((0x1U << (6U))));
