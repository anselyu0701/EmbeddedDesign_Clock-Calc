...
#line 124 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_gpio.c"
...
#line 150 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_gpio.c"

 
#line 160 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_gpio.c"
...
void HAL_GPIO_Init(GPIO_TypeDef  *GPIOx, GPIO_InitTypeDef *GPIO_Init)
{
  ...
  for (position = 0; position < ((uint32_t)16); position++)
  {
    ...
    if (iocurrent == ioposition)
    {
      ...
      switch (GPIO_Init->Mode)
      {
        ...
        case ((uint32_t)0x00000001):
          ...
          ((void)0);
          config = GPIO_Init->Speed + ((uint32_t)0x00000000);
          break;
          
         
        case ((uint32_t)0x00000011):
           
          ((void)0);
          config = GPIO_Init->Speed + ((uint32_t)0x00000004);
          break;
        ...
        case ((uint32_t)0x00000002):
          ...
          ((void)0);
          config = GPIO_Init->Speed + ((uint32_t)0x00000008);
          break;
          
         
        case ((uint32_t)0x00000012):
           
          ((void)0);
          config = GPIO_Init->Speed + ((uint32_t)0x0000000C);
          break;
          
         
        case ((uint32_t)0x00000000):
        case ((uint32_t)0x10110000):
        case ((uint32_t)0x10210000):
        case ((uint32_t)0x10310000):
        case ((uint32_t)0x10120000):
        case ((uint32_t)0x10220000):
        case ((uint32_t)0x10320000):
           
          ((void)0);
          if(GPIO_Init->Pull == ((uint32_t)0x00000000))
          {  
            config = ((uint32_t)0x00000000) + ((uint32_t)0x00000004);
          }
          else if(GPIO_Init->Pull == ((uint32_t)0x00000001))
          {
            config = ((uint32_t)0x00000000) + ((uint32_t)0x00000008);
        ...
        case ((uint32_t)0x00000003):
            config = ((uint32_t)0x00000000) + ((uint32_t)0x00000000);
          break;
      ...
      registeroffset = (iocurrent < ((uint16_t)0x0100)) ? (position << 2) : ((position - 8) << 2);
      
       
      ((((*configregister))) = (((((((*configregister)))) & (~((((0x3U << (0U)) | (0x3U << (2U))) << registeroffset )))) | ((config << registeroffset)))));
      
       
       
      if((GPIO_Init->Mode & ((uint32_t)0x10000000)) == ((uint32_t)0x10000000)) 
      {
         
        do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR) |= ((0x1U << (0U)))); tmpreg = ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR) & ((0x1U << (0U)))); ((void)(tmpreg)); } while(0);
        temp = ((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->EXTICR[position >> 2];
        ((temp) &= ~(((uint32_t)0x0F) << (4 * (position & 0x03))));
        ((temp) |= (((((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))))? 0U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))))? 1U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))))? 2U :3U)) << (4 * (position & 0x03))));
        ((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->EXTICR[position >> 2] = temp;
        

         
        if((GPIO_Init->Mode & ((uint32_t)0x00010000)) == ((uint32_t)0x00010000))
        {
          ((((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->IMR) |= (iocurrent)); 
        } 
        else
        {
          ((((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->IMR) &= ~(iocurrent)); 
        ...
        if((GPIO_Init->Mode & ((uint32_t)0x00020000)) == ((uint32_t)0x00020000))
        {
          ((((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->EMR) |= (iocurrent)); 
        } 
        else
        {
          ((((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->EMR) &= ~(iocurrent)); 
        ...
        if((GPIO_Init->Mode & ((uint32_t)0x00100000)) == ((uint32_t)0x00100000))
        {
          ((((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->RTSR) |= (iocurrent)); 
        } 
        else
        {
          ((((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->RTSR) &= ~(iocurrent)); 
        ...
        if((GPIO_Init->Mode & ((uint32_t)0x00200000)) == ((uint32_t)0x00200000))
        {
          ((((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->FTSR) |= (iocurrent)); 
        } 
        else
        {
          ((((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->FTSR) &= ~(iocurrent)); 
...
{ 
  ...
  while ((GPIO_Pin >> position) != 0)
  {
    ...
    if (iocurrent)
    {
      ...
      (((*configregister)) = ((((((*configregister))) & (~((((0x3U << (0U)) | (0x3U << (2U))) << registeroffset )))) | ((0x1U << (2U)) << registeroffset))));
      ...
      tmp = ((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->EXTICR[position >> 2];
      tmp &= (((uint32_t)0x0F) << (4 * (position & 0x03)));
      if(tmp == ((((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))))? 0U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))))? 1U : ((GPIOx) == (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))))? 2U :3U) << (4 * (position & 0x03))))
      {
        tmp = ((uint32_t)0x0F) << (4 * (position & 0x03));
        ((((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->EXTICR[position >> 2]) &= ~(tmp));
          
         
        ((((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->IMR) &= ~((uint32_t)iocurrent));
        ((((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->EMR) &= ~((uint32_t)iocurrent));
        
         
        ((((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->RTSR) &= ~((uint32_t)iocurrent));
        ((((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->FTSR) &= ~((uint32_t)iocurrent));
      }
    }
...
HAL_StatusTypeDef HAL_GPIO_LockPin(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin)
{
  ...
  if((uint32_t)(GPIOx->LCKR & (0x1U << (16U))))
  {
    return HAL_OK;
  }
  else
...
void HAL_GPIO_EXTI_IRQHandler(uint16_t GPIO_Pin)
{
  ...
  if((((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->PR & (GPIO_Pin)) != RESET) 
  { 
    (((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->PR = (GPIO_Pin));
