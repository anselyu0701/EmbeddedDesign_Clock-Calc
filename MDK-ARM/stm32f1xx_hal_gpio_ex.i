...
#line 59 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_gpio_ex.c"
...
void HAL_GPIOEx_ConfigEventout(uint32_t GPIO_PortSource, uint32_t GPIO_PinSource)
{
  ...
  (((((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->EVCR)) = ((((((((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->EVCR))) & (~(((0x7U << (4U)))|((0xFU << (0U)))))) | ((GPIO_PortSource)|(GPIO_PinSource)))));
}
...
void HAL_GPIOEx_EnableEventout(void)
{
  ((((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->EVCR) |= ((0x1U << (7U))));
}
