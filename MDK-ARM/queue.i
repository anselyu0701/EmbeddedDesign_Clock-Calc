...
#line 238 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
...
#line 258 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
	...
	if ((pxQueue) == 0) {ulPortSetInterruptMask(); for( ;; );};
...
QueueHandle_t xReturn = 0;
	...
	if ((uxQueueLength > ( UBaseType_t ) 0) == 0) {ulPortSetInterruptMask(); for( ;; );};
...
#line 481 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
 

#line 536 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
 

#line 578 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
 

#line 607 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
	...
	if ((pxQueue) == 0) {ulPortSetInterruptMask(); for( ;; );};
	if ((!( ( pvItemToQueue == 0 ) && ( pxQueue ->uxItemSize != ( UBaseType_t ) 0U ) )) == 0) {ulPortSetInterruptMask(); for( ;; );};
	if ((!( ( xCopyPosition == ( ( BaseType_t ) 2 ) ) && ( pxQueue ->uxLength != 1 ) )) == 0) {ulPortSetInterruptMask(); for( ;; );};

	{
		if ((!( ( xTaskGetSchedulerState() == ( ( BaseType_t ) 0 ) ) && ( xTicksToWait != 0 ) )) == 0) {ulPortSetInterruptMask(); for( ;; );};
	}
...
#line 691 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
				{
...
#line 897 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
 

#line 1052 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
	...
	uxSavedInterruptStatus = ulPortSetInterruptMask();
	{
		if( ( pxQueue->uxMessagesWaiting < pxQueue->uxLength ) || ( xCopyPosition == ( ( BaseType_t ) 2 ) ) )
		{
			...
			{
#line 1154 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
				{
					if( ( ( BaseType_t ) ( ( &( pxQueue ->xTasksWaitingToReceive ) )->uxNumberOfItems == ( UBaseType_t ) 0 ) ) == ( ( BaseType_t ) 0 ) )
					{
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
	...
	if ((pxQueue ->uxItemSize == 0) == 0) {ulPortSetInterruptMask(); for( ;; );};

	

 
	if ((!( ( pxQueue ->pcHead == 0 ) && ( pxQueue ->pcTail != 0 ) )) == 0) {ulPortSetInterruptMask(); for( ;; );};
	...
	uxSavedInterruptStatus = ulPortSetInterruptMask();
	{
		...
		if( pxQueue->uxMessagesWaiting < pxQueue->uxLength )
		{
			...
			if( pxQueue->xTxLock == ( ( BaseType_t ) -1 ) )
			{
#line 1315 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
				{
					if( ( ( BaseType_t ) ( ( &( pxQueue ->xTasksWaitingToReceive ) )->uxNumberOfItems == ( UBaseType_t ) 0 ) ) == ( ( BaseType_t ) 0 ) )
					{
						if( xTaskRemoveFromEventList( &( pxQueue->xTasksWaitingToReceive ) ) != ( ( BaseType_t ) 0 ) )
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
	...
	if ((pxQueue) == 0) {ulPortSetInterruptMask(); for( ;; );};
	if ((!( ( pvBuffer == 0 ) && ( pxQueue ->uxItemSize != ( UBaseType_t ) 0U ) )) == 0) {ulPortSetInterruptMask(); for( ;; );};
...
UBaseType_t uxReturn;
	...
	if ((xQueue) == 0) {ulPortSetInterruptMask(); for( ;; );};
...
#line 1762 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
 

#line 1772 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
 

#line 1782 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
...
#line 1931 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
			{
...
#line 2144 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
 

#line 2234 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
 

#line 2282 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
 

#line 2342 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
...
#line 2434 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
 

#line 2448 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
 

#line 2481 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
 

#line 2517 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
 

#line 2530 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
 

#line 2543 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
 

#line 2597 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\queue.c"
