...
#line 112 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\event_groups.c"
...
BaseType_t xTimeoutOccurred = ( ( BaseType_t ) 0 );
	...
	if ((( uxBitsToWaitFor & 0xff000000UL ) == 0) == 0) {ulPortSetInterruptMask(); for( ;; );};
	if ((uxBitsToWaitFor != 0) == 0) {ulPortSetInterruptMask(); for( ;; );};
...
BaseType_t xTimeoutOccurred = ( ( BaseType_t ) 0 );
	...
	if ((xEventGroup) == 0) {ulPortSetInterruptMask(); for( ;; );};
	if ((( uxBitsToWaitFor & 0xff000000UL ) == 0) == 0) {ulPortSetInterruptMask(); for( ;; );};
	if ((uxBitsToWaitFor != 0) == 0) {ulPortSetInterruptMask(); for( ;; );};
...
EventBits_t uxReturn;
	...
	if ((xEventGroup) == 0) {ulPortSetInterruptMask(); for( ;; );};
	if ((( uxBitsToClear & 0xff000000UL ) == 0) == 0) {ulPortSetInterruptMask(); for( ;; );};
...
#line 462 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\event_groups.c"
...
BaseType_t xMatchFound = ( ( BaseType_t ) 0 );
	...
	if ((xEventGroup) == 0) {ulPortSetInterruptMask(); for( ;; );};
	if ((( uxBitsToSet & 0xff000000UL ) == 0) == 0) {ulPortSetInterruptMask(); for( ;; );};
...
const List_t *pxTasksWaitingForBits = &( pxEventBits->xTasksWaitingForBits );
	...
	vTaskSuspendAll();
	{
		...
		while( ( ( pxTasksWaitingForBits )->uxNumberOfItems ) > ( UBaseType_t ) 0 )
		{
			...
			if ((pxTasksWaitingForBits->xListEnd . pxNext != ( ListItem_t * ) &( pxTasksWaitingForBits->xListEnd )) == 0) {ulPortSetInterruptMask(); for( ;; );};
...
#line 683 "..\\Middlewares\\Third_Party\\FreeRTOS\\Source\\event_groups.c"
