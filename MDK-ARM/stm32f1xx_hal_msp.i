...
#line 36 "..\\Src\\stm32f1xx_hal_msp.c"
...
void HAL_MspInit(void)
{
  ...
  HAL_NVIC_SetPriorityGrouping(((uint32_t)0x00000003));
  ...
  (((((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->MAPR)) = ((((((((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->MAPR))) & (~((0x7U << (24U))))) | ((0x1U << (26U))))));
...
void HAL_CRC_MspInit(CRC_HandleTypeDef* hcrc)
{
  ...
  if(hcrc->Instance==((CRC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x3000)))
  {
   

   
     
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->AHBENR) |= ((0x1U << (6U)))); tmpreg = ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->AHBENR) & ((0x1U << (6U)))); ((void)(tmpreg)); } while(0);
...
void HAL_CRC_MspDeInit(CRC_HandleTypeDef* hcrc)
{
  ...
  if(hcrc->Instance==((CRC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x3000)))
  {
    ...
    (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->AHBENR &= ~((0x1U << (6U))));
  }
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)))
  {
   

   
     
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR) |= ((0x1U << (12U)))); tmpreg = ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR) & ((0x1U << (12U)))); ((void)(tmpreg)); } while(0);
  
    


 
    GPIO_InitStruct.Pin = ((uint16_t)0x0020)|((uint16_t)0x0080);
    GPIO_InitStruct.Mode = ((uint32_t)0x00000002);
    GPIO_InitStruct.Speed = ((0x3U << (0U)));
    HAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), &GPIO_InitStruct);

     
  
    hdma_spi1_tx.Instance = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0030));
    hdma_spi1_tx.Init.Direction = ((uint32_t)(0x1U << (4U)));
    hdma_spi1_tx.Init.PeriphInc = ((uint32_t)0x00000000);
    hdma_spi1_tx.Init.MemInc = ((uint32_t)(0x1U << (7U)));
    hdma_spi1_tx.Init.PeriphDataAlignment = ((uint32_t)0x00000000);
    hdma_spi1_tx.Init.MemDataAlignment = ((uint32_t)0x00000000);
    hdma_spi1_tx.Init.Mode = ((uint32_t)0x00000000);
    hdma_spi1_tx.Init.Priority = ((uint32_t)0x00000000);
    if (HAL_DMA_Init(&hdma_spi1_tx) != HAL_OK)
    {
      Error_Handler();
    }

    do{ (hspi)->hdmatx = &(hdma_spi1_tx); (hdma_spi1_tx). Parent = (hspi); } while(0);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)))
  {
    ...
    (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR &= ~((0x1U << (12U))));
  
    


 
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0020)|((uint16_t)0x0080));
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  if(huart->Instance==((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)))
  {
    ...
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR) |= ((0x1U << (14U)))); tmpreg = ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR) & ((0x1U << (14U)))); ((void)(tmpreg)); } while(0);
    ...
    hdma_usart1_tx.Instance = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0044));
    hdma_usart1_tx.Init.Direction = ((uint32_t)(0x1U << (4U)));
    hdma_usart1_tx.Init.PeriphInc = ((uint32_t)0x00000000);
    hdma_usart1_tx.Init.MemInc = ((uint32_t)(0x1U << (7U)));
    hdma_usart1_tx.Init.PeriphDataAlignment = ((uint32_t)0x00000000);
    hdma_usart1_tx.Init.MemDataAlignment = ((uint32_t)0x00000000);
    hdma_usart1_tx.Init.Mode = ((uint32_t)0x00000000);
    hdma_usart1_tx.Init.Priority = ((uint32_t)(0x1U << (12U)));
    if (HAL_DMA_Init(&hdma_usart1_tx) != HAL_OK)
    {
      Error_Handler();
    }

    do{ (huart)->hdmatx = &(hdma_usart1_tx); (hdma_usart1_tx). Parent = (huart); } while(0);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  if(huart->Instance==((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)))
  {
    ...
    (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2ENR &= ~((0x1U << (14U))));
  
    


 
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0200)|((uint16_t)0x0400));
